...
const WealthPanel: React.FC = () => {
  ...
  const handleDiag = () => {
    ...
    const code = stockCode.toLowerCase().startsWith('sz') || stockCode.toLowerCase().startsWith('sh') 
      ? stockCode.toLowerCase() 
      : (stockCode.startsWith('6') ? `sh${stockCode}` : `sz${stockCode}`);
  ...
  return (
    <div className="p-6 h-full flex flex-col overflow-hidden bg-white text-gray-800">
      <div className="mb-6 border-b border-gray-200 pb-4">
        ...
        <p className="text-sm text-gray-500 mt-2">为您提供轻量化的智能选股与个股深度诊断服务</p>
      </div>
            ...
            <div className="flex-1 bg-gray-50 rounded-lg border border-gray-200 overflow-hidden">
              {diagUrl ? (
                ...
                <div className="h-full flex flex-col items-center justify-center text-gray-400">
                  <Icon icon="mdi:magnify-scan" className="text-6xl mb-4 opacity-50" />
