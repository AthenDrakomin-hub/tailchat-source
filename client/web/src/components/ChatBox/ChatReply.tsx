  ...
  return (
    <div className="relative min-w-0">
      <div className="absolute bottom-0 left-0 right-0 py-1 px-4">
        <div className="rounded bg-white dark:bg-gray-800 p-2 max-h-44 min-w-0 overflow-y-auto overflow-x-hidden shadow-sm relative">
          <span className="align-top break-words">
            {t('回复')}{' '}
            {replyMsg.author && <UserName userId={replyMsg.author} />}:{' '}
          </span>

          <span className="break-words">{getMessageRender(replyMsg.content)}</span>
