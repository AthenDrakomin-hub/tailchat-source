...
export const enTranslation = {
  ...
  custom: {
    ...
    config: {
      ...
      beidouStarsTitle: 'Beidou Stars Cards',
      beidouStarsTip:
        'Used for the Beidou Stars profile popup on the login page. Defaults will be used if not configured.',
      beidouCardAvatar: 'Avatar',
      beidouCardName: 'Name',
      beidouCardTitle: 'Title',
      beidouCardBio: 'Bio',
      beidouCardTags: 'Tags (comma separated)',
      beidouCardVerifiedText: 'Verified Text',
      beidouCardFooterLeftText: 'Footer Left Text',
      saveAll: 'Save All',
      configPanel: 'Config',
    ...
    wxnotify: {
      title: 'Wechat Notify Admin',
      tip: 'Check channel status, default rules, and send an admin-side test notification to a specified user.',
      available: 'Channel Available',
      unavailable: 'Channel Not Configured',
      token: 'AppToken',
      boundUserCount: 'Bound Users',
      successCount: 'Recent Success',
      failedCount: 'Recent Failed',
      defaultRules: 'Default Notify Rules',
      testUser: 'Test User',
      sendTest: 'Send Admin Test Notify',
      testSuccess: 'Wechat test notification sent',
      refresh: 'Refresh',
      filterAllType: 'All Types',
      filterAllStatus: 'All Status',
      filterTarget: 'Filter by target user ID',
      logType: 'Type',
      logStatus: 'Status',
