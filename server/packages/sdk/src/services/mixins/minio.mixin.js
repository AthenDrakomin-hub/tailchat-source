...
exports.TcMinioService = void 0;
const minio_1 = require('minio');
const ramda_adjunct_1 = require('ramda-adjunct');
const moleculer_1 = require('moleculer');
class MinioInitializationError extends moleculer_1.Errors.MoleculerError {
  /**
...
class MinioPingError extends moleculer_1.Errors.MoleculerRetryableError {
  /**
    ...
    listBuckets: {
      handler() {
        return this.client
          .listBuckets()
          .then((buckets) =>
            (0, ramda_adjunct_1.isUndefined)(buckets) ? [] : buckets
          );
      },
    },
    /**
      ...
      handler(ctx) {
        return this.Promise.resolve(ctx.params).then(
          ({ bucketName, objectName, sourceObject, conditions }) => {
            const _conditions = new minio_1.CopyConditions();
      ...
      handler(ctx) {
        return this.Promise.resolve(ctx.params).then(
          ({
            ...
            if ((0, ramda_adjunct_1.isString)(requestDate)) {
