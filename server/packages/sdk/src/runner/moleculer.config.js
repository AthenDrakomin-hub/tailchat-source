...
exports.defaultBrokerConfig = void 0;
const moment_1 = __importDefault(require('moment'));
const kleur_1 = __importDefault(require('kleur'));
const settings_1 = require('../services/lib/settings');
require('moleculer-repl');
/**
...
exports.defaultBrokerConfig = {
  ...
  cacher: {
    ...
    options: {
      ...
      prefix: 'TC',
      // Redis settings
      redis: settings_1.config.redisUrl,
    },
  },
  // Define a serializer.
  ...
  requestTimeout: settings_1.config.runner.requestTimeout,
  ...
  metrics: {
    enabled: settings_1.config.enablePrometheus,
      ...
      action(broker, args) {
        ...
        return broker
          ...
          .then((user) => {
            ...
            broker.call = function (actionName, params, opts) {
